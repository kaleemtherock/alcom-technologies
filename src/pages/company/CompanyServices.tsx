...
import { getRecommendations } from '../../data/servicesData';
...
const Services = () => {
  ...
  const handleServiceClick = (index: number) => {
    if (activeIndex === index) {
      ...
      setActiveTile(null);
      setActiveIndex(index);
      // Updated to use the imported getRecommendations
      const recommendedServices = getRecommendations(servicesData[index].text);
